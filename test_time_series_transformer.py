import torch
from prepare_data_timeseries_transformer import TimeSeriesImageDataset  # adjust import as needed
from train_time_series_transformer import TimeSeriesTransformer, MAX_SEQ_LENGTH  # if your model class is defined here
